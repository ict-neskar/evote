...
@section('content')
    ...
    <!-- Statistik -->
    <div class="w-100 margin-y-85 position-relative">
                ...
                <div class="bg-white-linear rounded-4 shadow-md overflow-hidden mb-lg-0 mb-4">
                    <div class="bg-circles d-flex justify-content-between padding-125">
                        <div class="margin-end-25 margin-start-5 margin-md-start-10 margin-xs-start-00">
                            <h1 class="fontw-9 font-15 mb-0">Padli</h1>
                            <p class="red margin-bottom-10 font-xs-8">XII RPL 2</p>
                            <div class="position-relative d-flex align-items-top margin-bottom-075">
                                <h1 class="font-40 fontw-9 red mb-0">0</h1>
                        ...
                        <div class="width-xs-30p margin-end-5 margin-md-end-10 margin-xs-end-00 ">
                            <img src="/assets/images/kandidat-1-pp.png" class="img-thumbnail rounded-circle border border-danger shadow-md" alt="Kandidat - 1">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="width-85p mx-auto position-relative overflow-hidden">
            <div class="d-flex justify-content-end">
                <a href="/kandidat" class="red d-flex align-items-center margin-top-20 width-175p" data-aos="fade-left" data-aos-duration="1000">
