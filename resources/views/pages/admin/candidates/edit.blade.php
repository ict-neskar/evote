...
@section('content')
    <div class="page-heading">
        ...
        <a href="/admin/kandidat/{{ $candidate->slug }}" class="btn icon icon-left btn-primary">
            ...
            <div class="col-12">
                <form action="/admin/kandidat" method="POST" novalidate enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="name" placeholder="Masukan nama kandidat" value="{{ old('name', $candidate->name) }}">
                                @error('name')<small class="text-red-600 font-medium block my-2">{{ $message }}</small>@enderror
                            </div>
                            <div class="form-group">
                                <label for="name">Votes</label>
                                <input type="text" name="votes" class="form-control" id="votes" readonly value={{ old('name', $candidate->votes) }}>
                    ...
                    <div class="card mt-3">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <h1>Deskripsi</h1>
                                <div class="myeditablediv" name="deskripsi" id="deskripsi" value="{{ old('deskripsi') }}">{!! $candidate->deskripsi !!}</div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h1>Visi</h1>
                            <div class="myeditablediv" name="visi" id="visi" value="{{ old('visi') }}">{!! $candidate->visi !!}</div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h1>Misi</h1>
                            <div class="myeditablediv" name="misi" id="misi" value="{{ old('misi') }}">{!! $candidate->misi !!}</div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h1>Program</h1>
                            <div class="myeditablediv" name="program" id="program" value="{{ old('program') }}">{!! $candidate->program !!}</div>
                            {{-- <h4 class="card-title">Mssi</h4>
